...
BEGIN_VS_SHADER( DEBUG_SHADOW, "" )
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_PIXEL_SHADER_OLD( debug_shadow_ortho_ps30 );
			SET_STATIC_PIXEL_SHADER_OLD( debug_shadow_ortho_ps30 );
		}
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_PIXEL_SHADER_OLD( debug_shadow_ortho_ps30 );
			SET_DYNAMIC_PIXEL_SHADER_OLD( debug_shadow_ortho_ps30 );
