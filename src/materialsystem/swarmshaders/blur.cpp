...
BEGIN_VS_SHADER( GAUSSIAN_BLUR_6, "" )
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_PIXEL_SHADER_OLD( gaussianblur_6_ps30 );
			SET_STATIC_PIXEL_SHADER_OLD( gaussianblur_6_ps30 );
		}
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_PIXEL_SHADER_OLD( gaussianblur_6_ps30 );
			SET_DYNAMIC_PIXEL_SHADER_OLD( gaussianblur_6_ps30 );
